...
namespace BeeGame.TerrainGeneration
{
    public class Block
    {
        ...
        public virtual THVector2[] FaceUVs(BlockDirection direction)
        {
            ...
            uVs[0] = new THVector2(tileSize * tilepos.x + tileSize, tileSize * tilepos.y);
            uVs[1] = new THVector2(tileSize * tilepos.x + tileSize, tileSize * tilepos.y + tileSize);
            uVs[2] = new THVector2(tileSize * tilepos.x, tileSize * tilepos.y + tileSize);
