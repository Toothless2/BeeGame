namespace BeeGame.Enums
{
    ...
    {
        FOREST, MEADOWS, TROPICAL, WINTRY, MODEST, MARSHY, ENDER, MONASTIC, STEADFAST, VALIANT, COMMON, CULTIVATED, DILIGENT, RURAL, FARMERLY, AGRARIAN, UNWEARY, INDUSTRIOUS, ICY, GLACIAL, NOBLE, IMPERIAL, MAJECTIC, MIRY, BOGGY, HERIOC, PHANTASMAL, SPECTRAL, HERMETIC, SECLUDED, SINISTER, FIENDISH, DEMONIC, FRUGAL, AUSTER, VINDICTIVE, EXOTIC, ENDEMIC, VENGEFUL, AVENGING, SETADFAST, HEROIC
    };
